...
QT_MOC_LITERAL(4, 41, 11), // "gameStarted"
QT_MOC_LITERAL(5, 53, 9), // "gameEnded"
QT_MOC_LITERAL(6, 63, 16), // "countdownUpdated"
QT_MOC_LITERAL(7, 80, 8), // "timeLeft"
QT_MOC_LITERAL(8, 89, 9), // "startGame"
QT_MOC_LITERAL(9, 99, 10), // "playerName"
QT_MOC_LITERAL(10, 110, 8) // "stopGame"

    },
    "HardwareInterface\0scoreUpdated\0\0"
    "newScore\0gameStarted\0gameEnded\0"
    "countdownUpdated\0timeLeft\0startGame\0"
    "playerName\0stopGame"
};
...
void HardwareInterface::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 3: _t->countdownUpdated((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 4: _t->startGame((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        ...
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&HardwareInterface::gameStarted)) {
                *result = 1;
                return;
            }
        }
        ...
        {
            using _t = void (HardwareInterface::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&HardwareInterface::countdownUpdated)) {
                *result = 3;
                return;
            }
        }
...
// SIGNAL 1
void HardwareInterface::gameStarted()
{
...
// SIGNAL 3
void HardwareInterface::countdownUpdated(int _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
